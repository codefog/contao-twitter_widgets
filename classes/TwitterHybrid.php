...
/**
 * Parent class for Twitter objects that can be modules or content elements.
 */
abstract class TwitterHybrid extends \Frontend
{
	 ...
	 * @var string
	 */
	protected $strTemplate = 'twitter_default';
	...
	public function generate()
	{
		...
		if ($this->twitter_template != '')
		{
			$this->strTemplate = $this->twitter_template;
		}
